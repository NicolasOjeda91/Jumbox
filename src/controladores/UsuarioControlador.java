...
public class UsuarioControlador implements UserRepository {
    ...
    public List<Persona> getAllUsers() {
        ...
        try {
            ...
            while (resultSet.next()) {
            	Persona user = new Persona(resultSet.getInt("id"), resultSet.getString("name"), resultSet.getString("email"));
                users.add(user);
            }
    ...
    public Persona getUserById(int id) {
        ...
        try {
            ...
            if (resultSet.next()) {
                user = new Persona (resultSet.getInt("id"), resultSet.getString("name"), resultSet.getString("email"));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
	...
	@Override
    public void addUser (Persona usuario) {
        try {
...
//            statement.setString(2, usuario.getEmail());
	...
	@Override
    public void updateUser(Persona usuario) {
        try {
